...
var WidgetMetadata = {
    ...
    modules: [
        ...
        {
            title: "今日影剧推荐",
            functionName: "loadCalendarTodayRecommendation",
            type: "video",
            cacheDuration: 43200,
            params: []
        },
        ...
        // ---------------- 大栏目 5：影剧风向标 (IMDb + 烂番茄 + Trakt + 豆瓣) ----------------
        {
            ...
            params: [
                ...
                },
                {
                    ...
                    enumOptions: [
                        { title: "本周热榜", value: "trending_week" }, { title: "今日热榜", value: "trending_day" }, { title: "流行趋势", value: "popular" }, { title: "高分神作", value: "top_rated" }
                    ]
                },
                {
                ...
                },
                {
                    ...
                    enumOptions: [
                        { title: "实时热播", value: "trending" }, { title: "最受欢迎", value: "popular" }, { title: "最受期待", value: "anticipated" }
                    ]
                },
                {
                ...
                { name: "platform_channel", title: "选择栏目", type: "enumeration", value: "tv_american", belongTo: { paramName: "hub_source", value: ["platform_douban"] }, enumOptions: [ { title: "英美剧", value: "tv_american" }, { title: "韩剧", value: "tv_korean" }, { title: "日剧", value: "tv_japanese" }, { title: "国产剧", value: "tv_domestic" }, { title: "日本动画", value: "tv_animation" }, { title: "实时热门电影", value: "movie_hot" }, { title: "一周口碑电影", value: "movie_weekly" }, { title: "豆瓣 Top250", value: "movie_top250" }, { title: "院线热映", value: "movie_showing" }, { title: "国内综艺", value: "show_domestic" }, { title: "国外综艺", value: "show_foreign" }, { title: "全球口碑剧集", value: "tv_global_best" }, { title: "华语口碑剧集", value: "tv_chinese_best" } ] },
                { name: "theater_brand", title: "剧场品牌", type: "enumeration", value: "迷雾剧场", belongTo: { paramName: "hub_source", value: ["platform_theater"] }, enumOptions: [ { title: "迷雾剧场", value: "迷雾剧场" }, { title: "白夜剧场", value: "白夜剧场" }, { title: "X剧场", value: "X剧场" }, { title: "十分短剧", value: "横屏短剧" }, { title: "生花剧场", value: "生花剧场" }, { title: "大家剧场", value: "大家剧场" }, { title: "小逗剧场", value: "小逗剧场" }, { title: "十分剧场", value: "十分剧场" }, { title: "板凳单元", value: "板凳单元" }, { title: "萤火单元", value: "萤火单元" }, { title: "正午阳光", value: "正午阳光" }, { title: "恋恋剧场", value: "恋恋剧场" }, { title: "微尘剧场", value: "微尘剧场" } ] },
            ...
            params: [
                {
                    ...
                    enumOptions: [
                        ...
                        { title: "年度佳片榜", value: "yearly" },
                        { title: "影院热映榜", value: "release" }
                    ]
                },
                { name: "release_category", title: "上映频道", type: "enumeration", value: "movie_upcoming", belongTo: { paramName: "movie_source", value: ["release"] }, enumOptions: [ { title: "即将上映", value: "movie_upcoming" }, { title: "正在热映", value: "movie_now_playing" } ] },
                { name: "general_sort", title: "榜单分类", type: "enumeration", value: "popular", belongTo: { paramName: "movie_source", value: ["general"] }, enumOptions: [ { title: "流行趋势榜", value: "popular" }, { title: "历史高分榜", value: "top_rated" }, { title: "全球票房榜", value: "box_office" }, { title: "奥斯卡佳片", value: "oscar" } ] },
        ...
        // ---------------- 大栏目 1：二次元全境聚合 ----------------
        {
            ...
            params: [
                ...
                { name: "mal_sort", title: "榜单类型", type: "enumeration", value: "airing", belongTo: { paramName: "anime_source", value: ["mal"] }, enumOptions: [ { title: "当前热播", value: "airing" }, { title: "历史总榜", value: "all" } ] },
            ...
            params: [
                ...
                },
                {
                    ...
                    enumOptions: [
                        ...
                        { title: "流行趋势", value: "trend" },
                        { title: "高分神级", value: "top" }
                    ]
                },
                { name: "page", title: "页码", type: "page", startPage: 1 }
            ]
        ...
        {
            title: "平台分流片库",
            functionName: "loadPlatformHub",
            type: "video",
            cacheDuration: 3600,
            params: [
                { name: "hub_mode", title: "筛选模式", type: "enumeration", value: "network", enumOptions: [ { title: "播出平台", value: "network" }, { title: "出品公司", value: "company" } ] },
                { name: "with_networks", title: "播出平台", type: "enumeration", value: "2007", belongTo: { paramName: "hub_mode", value: ["network"] }, enumOptions: [ { title: "腾讯视频", value: "2007" }, { title: "爱奇艺", value: "1330" }, { title: "优酷", value: "1419" }, { title: "Bilibili", value: "1605" }, { title: "芒果TV", value: "1631" }, { title: "Netflix", value: "213" }, { title: "Disney+", value: "2739" }, { title: "HBO", value: "49" }, { title: "HBO Max", value: "3186" }, { title: "Apple TV+", value: "2552" }, { title: "Hulu", value: "453" }, { title: "Amazon Prime Video", value: "1024" }, { title: "FOX", value: "19" }, { title: "Paramount+", value: "4330" }, { title: "TV Tokyo", value: "94" }, { title: "BBC One", value: "332" }, { title: "BBC Two", value: "295" }, { title: "NBC", value: "6" }, { title: "AMC+", value: "174" }, { title: "We TV", value: "3732" }, { title: "Viu TV", value: "2146" }, { title: "TVB", value: "48" } ] },
                ...
                { name: "with_companies", title: "出品公司", type: "enumeration", value: "3", belongTo: { paramName: "hub_mode", value: ["company"] }, enumOptions: [ { title: "皮克斯 Pixar", value: "3" }, { title: "DC Universe", value: "128064" }, { title: "Disney", value: "2" }, { title: "Warner Bros", value: "174" }, { title: "Columbia", value: "5" }, { title: "Sony", value: "34" }, { title: "Universal", value: "33" }, { title: "Paramount", value: "4" }, { title: "20th Century", value: "25" }, { title: "Marvel", value: "420" }, { title: "Toho", value: "882" }, { title: "中国电影集团公司", value: "14714" }, { title: "BBC", value: "3324" }, { title: "A24", value: "41077" }, { title: "Blumhouse", value: "3172" }, { title: "Working Title Films", value: "10163" } ] },
                ...
                { name: "sort_by", title: "排序方式", type: "enumeration", value: "date_desc", enumOptions: [ { title: "上映时间降序", value: "date_desc" }, { title: "上映时间升序", value: "date_asc" }, { title: "人气最高", value: "popularity.desc" }, { title: "评分最高", value: "vote_average.desc" }, { title: "最多投票", value: "vote_count.desc" } ] },
                { name: "page", title: "页码", type: "page" },
...
function platformHubSort(value, fallback) {
...
async function loadPlatformHub(params = {}) {
    const mode = params.hub_mode || "network";
    const page = Number(params.page || 1);
    const language = params.language || "zh-CN";
    const released = params.air_status === "released";
    const upcoming = params.air_status === "upcoming";
    const date = platformHubDate();
    try {
        if (mode === "network") {
...
async function routeMovieOmni(params) {
    ...
    if (source === "release") { subParams.category = params.release_category || "movie_upcoming"; return await loadMovieReleaseTracker(subParams); }
    return [];
}
...
function liteCleanDoubanTitle(title) {
    return String(title || "").trim().replace(/第[一二三四五六七八九十百\\d]+[季部]/g, "").replace(/season\\s*\\d+/ig, "").replace(/\\s+/g, " ").trim();
}
...
async function liteSearchTmdb(title, year, isTv) {
    ...
    try {
        ...
        if (year) {
            const y = Number(year);
            const match = list.find(item => Math.abs(Number(String(item.release_date || item.first_air_date || "0").slice(0,4)) - y) <= 1);
            if (match) return match;
        }
        if (isTv) return list.find(item => item.media_type === "tv") || list[0];
        return list[0];
    } catch (e) { return null; }
}

async function loadLiteDouban(params = {}) {
    const category = params.category || "tv_american";
    const base = LITE_DOUBAN_URLS[category];
    if (!base) return [{ id: "config-error", type: "text", title: "配置错误", description: "未找到豆瓣栏目" }];
    const page = Number(params.page || 1);
    const url = `${base}?start=${(page - 1) * 20}&count=20`;
    const isTv = category.startsWith("tv_") || category.startsWith("show_");
    try {
        const res = await Widget.http.get(url, { headers: { Referer: "https://m.douban.com/", "User-Agent": "Mozilla/5.0" } });
        const data = typeof res.data === "string" ? JSON.parse(res.data) : res.data;
        const items = data?.subject_collection_items || [];
        const mapped = await Promise.all(items.map(async item => {
            const tmdb = await liteSearchTmdb(liteCleanDoubanTitle(item.title), item.year, isTv);
            if (!tmdb) return null;
            const date = tmdb.release_date || tmdb.first_air_date || String(item.year || "");
            return { id: tmdb.id, type: "tmdb", mediaType: tmdb.media_type || (isTv ? "tv" : "movie"), title: tmdb.title || tmdb.name || item.title, genreTitle: getGlobalGenreText(tmdb.genre_ids), subTitle: date, description: `${date}${item.info ? "\\n" + item.info : (tmdb.overview ? "\\n" + tmdb.overview : "")}`, posterPath: tmdb.poster_path, backdropPath: tmdb.backdrop_path, rating: Number(item.rating?.value || tmdb.vote_average || 0), releaseDate: date };
        }));
        return mapped.filter(Boolean);
    } catch (e) { return [{ id: "douban-error", type: "text", title: "豆瓣加载失败", description: "请稍后重试或检查网络" }]; }
}
...
const PlatformTheaterUtils = {
    ...
    async fetch(filename) {
        ...
        try {
            ...
            console.error(`[PlatformTheater] ${url}: ${e.message}`);
...
async function loadPlatformDouban(params = {}) {
    const data = await PlatformTheaterUtils.fetch("douban-hot.json");
    if (data === PlatformTheaterUtils.emptyTips) return data;
    const list = PlatformTheaterUtils.sortList(data?.[params.channel || "tv"] || [], params.sort_type);
    return PlatformTheaterUtils.paginate(list, params.page);
}

async function loadPlatformTheater(params = {}) {
    ...
    list = PlatformTheaterUtils.sortList(list, params.sort_type);
    return PlatformTheaterUtils.paginate(list, params.page);
}
...
async function mapCalendarItems(sourceItems) {
    ...
    const results = await Promise.all(items.map(async item => {
        if (!item || (!item.id && !item.tmdb_id)) return null;
...
async function fetchCalendarHomeData(type) {
    const suffix = CALENDAR_SUFFIX[type];
    if (!suffix) return [];
    const response = await Widget.http.get(`${CALENDAR_HOME_URL}/${suffix}.json`);
    const data = response.data;
    if (!Array.isArray(data)) return [];
    if (type === "今日推荐") {
        const section = data.find(item => item.type === "1s");
        return mapCalendarItems(section?.content || []);
    }
    const section = data.find(item => item.title === type);
    return mapCalendarItems(section?.content || []);
}
...
async function searchRtTmdb(rtItem, rank) {
    ...
    try {
        ...
        return {
            id: String(match.id), tmdbId: match.id, type: "tmdb", mediaType: rtItem.mediaType, title: match.name || match.title, 
...
async function handleTraktList(listType, traktType, traktClientId, page) {
    ...
    const promises = rawData.slice(0, 20).map(async (item, index) => {
        ...
        let stats = listType === "trending" ? ` ${item.watchers || 0} 人在看` : (listType === "anticipated" ? ` ${item.list_count || 0} 人想看` : `No. ${(page - 1) * 15 + index + 1}`); 
...
// 上映与热映榜：并入全能电影榜单
// =========================================================================
const RELEASE_TRACKER_GENRE_MAP = {
    10759: "动作冒险", 16: "动画", 35: "喜剧", 80: "犯罪", 99: "纪录片",
    18: "剧情", 10751: "家庭", 9648: "悬疑", 10764: "真人秀", 10765: "科幻",
    28: "动作", 12: "冒险", 14: "奇幻", 878: "科幻", 27: "恐怖",
    10749: "爱情", 53: "惊悚", 10752: "战争"
};

function getReleaseTrackerGenre(ids) {
    if (!Array.isArray(ids)) return "影视";
    return ids.map(id => RELEASE_TRACKER_GENRE_MAP[id]).filter(Boolean).slice(0, 1).join("") || "影视";
}

function buildReleaseTrackerItem(item, mediaType) {
    if (!item) return null;
    ...
    let dateLabel = releaseDate ? ` ${releaseDate}` : " 日期未知";
    if (releaseDate) {
...
async function loadMovieReleaseTracker(params = {}) {
    ...
    try {
        ...
        return [{ id: "error", type: "text", title: "加载失败", description: "获取上映与热映数据失败" }];
    }
}
